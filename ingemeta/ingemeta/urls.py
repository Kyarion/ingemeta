...
urlpatterns = [
    ...
    path('produccion/inicio_cambio_rollo/', views.inicio_cambio_rollo, name='inicio_cambio_rollo'),
    ...
    path('setup-ajustes-lista/', views.setup_ajustes_lista, name='setup_ajustes_lista'),
